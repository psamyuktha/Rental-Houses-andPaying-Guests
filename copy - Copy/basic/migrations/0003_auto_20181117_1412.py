    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenities', models.ManyToManyField(to='basic.Amenities')),
            ],
        ),
        migrations.CreateModel(
            name='House',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='basic.Address')),
        ...
        migrations.AddField(
            ...
            name='pr_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='basic.Property_Upload'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='house',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='basic.Pricing_House'),
        ),
        migrations.AddField(
            model_name='hostel',
            name='pr_id',
        ...
        migrations.AddField(
            model_name='hostel',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='basic.Pricing_Hostel'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='booking_hostel',
            name='bed_type',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='basic.Bed_Type'),
        ),
        migrations.AddField(
            model_name='booking_hostel',
            name='user_id',
