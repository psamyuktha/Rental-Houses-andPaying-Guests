...
class Amenities(models.Model):
    ...
    pictures=models.ImageField(upload_to='pics',blank=True)
    def __str__(self):
...
class House(models.Model):
    ...
    gallery = models.ImageField(upload_to='pics',blank=True)
    gallery1 = models.ImageField(upload_to='pics',blank=True)
    gallery2= models.ImageField(upload_to='pics',blank=True)
