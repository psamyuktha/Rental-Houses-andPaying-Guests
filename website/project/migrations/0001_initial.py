    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bed_type', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='project.Bed_Type')),
            ],
        ),
        migrations.CreateModel(
            name='Booking_House',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amenities', models.ManyToManyField(to='project.Amenities')),
            ],
        ),
        migrations.CreateModel(
            name='House',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='project.Address')),
                ('pr_type', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='project.Property_Type')),
        ...
        migrations.AddField(
            ...
            name='pr_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='project.Property_Upload'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='house',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='project.Pricing_House'),
        ),
        migrations.AddField(
            model_name='hostel',
            name='pr_id',
        ...
        migrations.AddField(
            model_name='hostel',
            name='price',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='project.Pricing_Hostel'),
        ),
        migrations.AddField(
